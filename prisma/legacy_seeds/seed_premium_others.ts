...
<style>
  ...
  .bullet-list { padding-left: 15px; margin: 0; font-size: 11px; color: #555; line-height: 1.5; }
</style>
`;
...
<div class="premium-receipt">
  ...
  <div style="text-align: right;">
    ...
    <div class="total-row" style="margin-top: 10px; border-top: 1px solid #eee; pt: 5px;">
...
<div class="premium-receipt">
  ...
  <div style="margin-top: 15px; border: 1px dashed #2563eb; padding: 10px; border-radius: 4px; text-align: center; color: #2563eb;">
...
async function main() {
  ...
  console.log("Premium Sale and Return templates seeded successfully");
}
